...
class RangeIterator {
    ...
    current() {
        const value = this._min + (this._step * this._pointer);
...
Object.defineProperty(exports, "__esModule", { value: true });
const Backbone = __webpack_require__(0);
const INITIAL_VALUE_DEVIATION = 0.8;
const MAX_INITIAL_VALUE = 4;
const MIN_INITIAL_VALUE = 2;
...
Object.defineProperty(exports, "__esModule", { value: true });
const Backbone = __webpack_require__(0);
const RangeIterator_1 = __webpack_require__(5);
const Value_1 = __webpack_require__(6);
...
Object.defineProperty(exports, "__esModule", { value: true });
const Backbone = __webpack_require__(0);
const Values_1 = __webpack_require__(12);
const CellIndexIterator_1 = __webpack_require__(13);
const ValueIterator_1 = __webpack_require__(14);
const Grid_1 = __webpack_require__(16);
const Value_1 = __webpack_require__(6);
class Game extends Backbone.Model {
    ...
    defaults() {
        return {
            ...
            score: 0,
            size: 4,
            vals: new Values_1.Values()
        };
    }
    addValues(values) {
        this.locked = true;
        values.forEach((valueLiteral) => {
            const cell = this.grid.getCell(valueLiteral.index);
            let valueAttributes;
            if (undefined === cell) {
            ...
            this.vals.add(new Value_1.Value(valueAttributes));
        });
        this.locked = false;
        return this;
    }
    moveValues(direction) {
        const isVerticalMovement = (0 !== direction.top);
        const isIncrementalMovement = (1 === direction.left || 1 === direction.top);
        const groupBy = isVerticalMovement ? 'column' : 'row';
        const increment = isIncrementalMovement ? 1 : -1;
        const start = isIncrementalMovement ? 0 : this.size - 1;
    ...
    canMove() {
        const isVerticalMovement = true;
        const isIncrementalMovement = true;
        const cellIndexes = new CellIndexIterator_1.CellIndexIterator(this.size, isVerticalMovement, isIncrementalMovement);
        for (const cellIndex of cellIndexes) {
            const value = this.vals.getByCellIndex(cellIndex);
            let right;
            let bottom;
            if (undefined === value) {
                return true;
...
const Cells_1 = __webpack_require__(11);
const Cell_1 = __webpack_require__(4);
class Grid extends Backbone.Model {
    constructor(attributes) {
        super(attributes);
        _.each(_.range(this.size), (row) => {
            _.each(_.range(this.size), (column) => {
                this.cells.add(new Cell_1.Cell({
                    row,
                    column
                }));
            });
    ...
    getRandomCell(exclude) {
        const cells = this.getCells(exclude);
        if (0 === cells.length) {
    ...
    isValidIndex(index) {
        return (index.row >= 0 && index.row < this.size &&
...
Object.defineProperty(exports, "__esModule", { value: true });
const Backbone = __webpack_require__(0);
const prefixedEventListener_1 = __webpack_require__(2);
const Cell_1 = __webpack_require__(4);
class Container extends Backbone.View {
    ...
    move() {
        const distance = Cell_1.Cell.distance(this.model.cell, this.model.move);
...
const KEY_LEFT = 37;
const KEY_BOTTOM = 40;
const KEYS = [KEY_RIGHT, KEY_LEFT, KEY_BOTTOM, KEY_TOP];
    ...
    render() {
        ...
        _.each(_.range(0, size), (row) => {
            ...
            _.each(_.range(0, size), (column) => {
                ...
                const td = new TableCell_1.TableCell({
                    model: cell
                });
                this.tds.push(td);
...
Object.defineProperty(exports, "__esModule", { value: true });
const Backbone = __webpack_require__(0);
class TableCell extends Backbone.View {
    get tagName() {
        return 'td';
    }
    get className() {
...
Object.defineProperty(exports, "__esModule", { value: true });
const jQuery = __webpack_require__(1);
const _2048_1 = __webpack_require__(8);
jQuery(($) => {
